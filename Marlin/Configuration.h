...
#define STRING_CONFIG_H_AUTHOR "(@irrlphnt)" // Who made the changes.
...
#define DELTA
  ...
  #define DELTA_HEIGHT 328.70             // (mm) Get this value from G33 auto calibrate
...
#define MANUAL_Z_HOME_POS DELTA_HEIGHT //Distance between bed and top of print area
